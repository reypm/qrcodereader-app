                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    <table class="w-full divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <th scope="col"
                                                class="px-6 py-3 text-center font-medium text-gray-500 dark:text-white uppercase tracking-wider">
                                                ID
                                            </th>
                                            <th scope="col"
                                                class="px-6 py-3 text-center font-medium text-gray-500 dark:text-white uppercase tracking-wider">
                                        ...
                                        @foreach ($submissions as $submission)
                                            <tr class="border-b border-gray-200 dark:border-gray-600">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-gray-400">
                                                    @if(filter_var($submission->code, FILTER_VALIDATE_URL))
                                                        <a href="{{ $submission->code }}" target="_blank"
                                                           rel="noopener noreferrer">{{ $submission->code }}</a>
                                                    @else
                                                        {{ $submission->code }}
                                                    @endif
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap font-medium inline-flex">
                                                    <a href="{{ route('submission.show', $submission) }}"
                                                       class="text-indigo-600 hover:text-indigo-100">
                                                    ...
                                                    <a href="{{ route('submission.edit', $submission) }}"
                                                       class="text-indigo-600 hover:text-indigo-100">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                             viewBox="0 0 24 24" stroke-width="1.5"
                                                             stroke="currentColor"
                                                    ...
                                                    <form
                                                        action="{{ route('submission.destroy', ['submission' => $submission]) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit">
